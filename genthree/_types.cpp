...
{
  sInt ix,iy,iz;
  ix = sRange<sInt>(x*512,511,-511)&0x3ff;
  iy = sRange<sInt>(y*512,511,-511)&0x3ff;
  iz = sRange<sInt>(z*512,511,-511)&0x3ff;
...
void sVector::UnitSafe3()                                    {sF32 e=Dot3(*this); if(e>0.000001) Scale3(sFInvSqrt(e)); else Init3(1,0,0);}
...
void RangeCoder::EncodeGamma(sU32 value)
{
  sInt invertlen;
  sU32 invert;
...
void RangeModel::Init(sInt symbols)
{
  sInt i;
...
#if !sPLAYER
void RangeModel::Encode(RangeCoder &coder,sInt symbol)
{
