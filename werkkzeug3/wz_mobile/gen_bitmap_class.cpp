...
public:
  Class_Bitmap_Color()
  {
    ...
    Inputs.Add(GenInput::Make(1,Output,0,GIF_REQUIRED));
    TILE_ADD(Tile_Color);
    Para.Add(GenPara::MakeChoice(1,"Mode","mul|add|sub|gray|invert|scale",0,GPF_FULLWIDTH|GPF_LABEL));
...
public:
  Class_Bitmap_Add()
  {
    ...
    Para.Add(GenPara::MakeChoice(1,"Mode","add|sub|mul|diff|make alpha",0));
  }
};
...
public:
  Class_Bitmap_Rotate()
  {
    ...
    Para.Add(GenPara::MakeFloatV(3,"Scroll"   ,2,16,-16,0.50f,0.001f));
...
public:
  Class_Bitmap_Bump()
  {
    ...
    Para.Add(GenPara::MakeFloatV(10,"Spec Power",1,16,0,4,0.02f));
    Para.Add(GenPara::MakeFloatV(11,"Spec Amplify",1,4,0,1.00f,0.001f));
  }
};
