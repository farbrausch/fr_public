...
#define CMD_VIEW_PULLDOWN           0x0122
#define CMD_VIEW_EXPORTBITMAP       0x0123
#define CMD_VIEW_GOFREECAMERA       0x0124
...
#define CMD_VIEW_HELP_DEFAULT       0x01e0
#define CMD_VIEW_HELP_BITMAP        0x01e1
#define CMD_VIEW_HELP_MESH          0x01e2
#define CMD_VIEW_HELP_MATERIAL      0x01e3
...
class WinView : public sGuiWindow
{
  ...
  void CalcShowSize(sInt &xs,sInt &ys);
public:
  WinView();
  ~WinView();
  void Tag();
  ...
  void ExportBitmap(GenBitmap *gbm);
