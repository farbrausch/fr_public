...
#define CMD_PARA_POPUP        0x0117
#define CMD_PARA_PULLDOWN     0x0118
#define CMD_PARA_HELP         0x0119
#define CMD_PARA_HELPOP       0x011a
...
#define CMD_PARA_COLORPICKER 0x15600
...
//  sInt Spline;
  ...
  const sChar *FileRequesterExtensions;
...
public:
  ...
  sControl *EditFileName(const sChar *name,sInt index,const sChar *ext);
  ...
  sControl *EditAngles(const sChar *name,sInt offset,sInt zones,sF32 def,sF32 min,sF32 max,sF32 step=0.01f);
  sControl *EditPos2D(const sChar *name,sInt offset,sInt zones,sF32 def,sF32 min,sF32 max,sF32 step=0.01f);
...
#define CMD_ANIMPAGE_GOTOSPLINE 0x1005
#define CMD_ANIMPAGE_POPUP      0x1006
#define CMD_ANIMPAGE_PULLDOWN   0x1007
