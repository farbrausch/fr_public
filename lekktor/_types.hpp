...
__forceinline void sCopyMem(const sPtr dd,const sPtr ss,sInt c)      { memcpy(dd,ss,c); }
__forceinline sInt sCmpMem(const sPtr dd,const sPtr ss,sInt c)       { return memcmp(dd,ss,c); }
...
sDLLSYSTEM void sPrint(sChar *text);
sDLLSYSTEM void __cdecl sPrintF(sChar *format,...);
